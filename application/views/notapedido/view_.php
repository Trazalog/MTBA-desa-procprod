                            ...
                            <div role="tabpanel" class="tab-pane active" id="choras">
                              ...
                              <div class="row" >
                                ...
                                <div class="col-xs-4"><label>Orden de Trabajo Nº</label> <strong style="color: #dd4b39;">*</strong> : 
                                  ...
                                  <input  id="id_ordTrabajo" name="" class="form-control" value="<?php echo $deta[0]['id_orden']; ?>"  disabled/>
                                </div>
                                <div class="col-xs-8"><label>Detalle</label> <strong style="color: #dd4b39">*</strong> :  
                                  <input  id="detaorden" name="" class="form-control" value="<?php echo $deta[0]['descripcion']; ?>" disabled/>
                                </div>
                              ...
                              <div class="row" >
                                ...
                                <div class="col-xs-4"><label>Medida</label> <strong style="color: #dd4b39">*</strong> :  
    ...
    //     $('#error').fadeOut('slow');
      ...
      $.ajax({    
                  ...
                  success: function(result){                                                    
                          ...
                          setTimeout("cargarView('Otrabajo', 'listOrden', '"+$('#permission').val()+"');",0);
                  },
                  error: function(result){
                          WaitingClose();                                                    
