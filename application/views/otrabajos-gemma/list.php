                  ...
                  $usrId= $userdata[0]['usrId']; 
                    ...
                    if ($a['estado'] !='T' && $a['estado'] !='E' ) {
                      ...
                      if (strpos($permission,'Pedidos') !== false) {
                        ...
                        echo '<i class="fa fa-sticky-note-o" style="color: #D2691E; cursor: pointer; margin-left: 15px;"  title="Asignar tarea " data-toggle="modal" data-target="#modalasigna" id="btnAddtarea"></i>';
                       
                      }
                      if($a['estado'] == 'As' && $a['id_usuario_a'] == $usrId ){
...
$(document).ready(function(event) {
  ...
  $('#btnAddtarea').click( function cargarVista(){
    ...
    <div class="modal-content">
      ...
      <div class="modal-body input-group ui-widget" id="modalBodyArticle">
        ...
        <div class="row">
          ...
          <div class="col-xs-8">
              <input type="date" class="form-control" id="vfech" placeholder="dd-mm-aaaa" name="vfech">
          </div>
        </div><br>
