                    ...
                    <table id="otrabajo" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($list as $o) {
                                ...
                                echo '<td><i onclick="mostrar_detalles(this)" class="fa fa-fw fa-search" style="color: #3c8dbc; cursor: pointer; margin-left: 15px;" title="Consultar"></i><i onclick="verOT(\''.$o['cod_interno'].'\')" class="fa fa-fw fa-eye" style="color: #3c8dbc; cursor: pointer; margin-left: 15px;" title="Ver OT"></i></td>';
