                                ...
                                <div class="col-xs-12">
                                    <div class="box">
                                        ...
                                        <div class="box-body"> 
                                            ...
                                            <div class="form-group">
                                                <label style="margin-top: 7px;"> Archivo Adjunto de OCs de Repuesto: <a id="linkOc_repuesto" target="_blank" <?php echo ($Oc_repuesto==''? '':'href="'.base_url().$Oc_repuesto.'"');?>>Ver y Descargar</a></label>
                                            </div>
                                                            
                                            <div class="form-group">
                                                <div class="col-xs-12">
                                                    <!-- Modal formulario tarea -->
                                                     <button type="button" id="formulario" class="btn btn-primary" onclick="getformulario()">Adjuntar OCs de Repuesto</button>
                                                </div>
                                            </div>
                                                <br> <br>  
