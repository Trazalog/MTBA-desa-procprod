              ...
              <div class="form-group">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <button class="btn btn-block btn-info" style="width: 100px; margin-top: 10px;" onclick="tomarTarea()">Tomar tarea</button>

                      <button class="btn btn-block btn-warning" style="width: 100px; margin-top: 10px;" onclick="soltarTarea()">Soltar tarea</button>
