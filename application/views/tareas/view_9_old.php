                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-12 col-md-12">
                                                            ...
                                                            <?php if($idForm != 0){echo '<button type="button" id="formulario" class="btn btn-primary" data-toggle="modal"
                                                                data-target="#modalForm" onclick="getformulario()">Completar
                                                                Formulario
                                                                </button>';}?>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-header">Adjuntar Archivo de Cotizacion</div>
                                    <div class="box-body">
                                        <?php 
                                            //print_r($formularios);
                                            ?>
                                        <br>
                                        <button type="button" id="formulario" class="btn btn-primary" data-toggle="modal"
                                            data-target="#modalFormCotizacion" onclick="getformulario()">Adjuntar
                                            Cotizacion</button>
                                    </div>
                                </div>
                            </div>
    ...
    function guardarComentario() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                lista.append('<hr/><li><h4>' + 'Nombre de Usuario' +
                    '<small style="float: right">Hace un momento</small></h4><p>' + comentario +
                    '</p></li>');
                $('#comentario').val('');
            },
            error: function(result) {
...
<div class="modal fade bs-example-modal-lg" id="modalFormCotizacion" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <?php
                                    if($formCotizacion != ''){
                                        cargarFormulario($formCotizacion);
                                    }                                    
                                    ?>
                                </div>
                            </div>
