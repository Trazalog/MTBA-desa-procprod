					...
					<div class="box box-success collapsed-box box-solid">
						<div class="box-header with-border">
							...
							<div class="box-tools pull-right">
								<button id="btnNuevo" type="button" class="btn btn-box-tool" data-widget="collapse">
						...
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12 col-sm-6">
									<div class="form-group">
										<label style="margin-top: 7px;">Descripción:
								...
								<div class="col-sm-12 col-sm-3">
									<div class="form-group">
										<label style="margin-top: 7px;">Subsector:
											<strong style="color: #dd4b39">*</strong>: </label>
								...
								<div class="col-sm-12 col-sm-3">
									<div class="form-group">
										<button style="margin-top: 30px;" class="btn btn-success" data-toggle="modal" data-target="#modalAgregar">
											<i class="fa fa-plus"></i> Nuevo Subsector</button>
									</div>
								</div>
								<div class="col-sm-12 col-sm-6">
									<div class="form-group">
										<label style="margin-top: 7px;">Capacidad:
											<strong style="color: #dd4b39">*</strong>: </label>
							...
							<div class="form-group">
								<button class="btn btn-primary" style="float: right" onclick="guardarEquipo()">Guardar</button>
							</div>
...
<script>
	...
	function ActualizarPagina() {
		$('.content').empty();
		$(".content").load(
			"<?php echo base_url(); ?>index.php/Equipo/index/<?php echo $permission; ?>"
		);
	}
</script>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<span id="modalAction" class="fa fa-plus-square btncolor " style="color: #6aa61b"> </span> Nuevo Subsector </h4>
			</div>
			<center>
				<h4>Descripción:
					<input id='nuevoSubsector'></input>
				</h4>
			</center>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<span id="modalAction" class="fa fa-pencil-square btncolor " style="color: #6aa61b"> </span> Modfiicar Equipo </h4>
			</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<span id="modalAction" class="fa fa-plus-square btncolor " style="color: #6aa61b"> </span> Eliminar Equipo </h4>
			</div>
			<center>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<span id="modalAction" class="fa fa-search btncolor " style="color: #6aa61b"> </span> Ver Equipo </h4>
			</div>
			<form id="form-create-empleado" style="margin:25px;padding:0px 15px;" class="form-horizontal">
				<div class="form-group">
					<label style="margin-top: 7px;">Descripción:
