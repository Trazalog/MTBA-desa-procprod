		...
		<div class="modal-content">
			...
			<div class="modal-body input-group ui-widget" id="modalBodyArticle">
				...
				<div class="row">
					...
					<div class="col-xs-8">
						<input type="text" class=" datepicker" id="vfecha" name="vfecha" value="<?php echo date_format(date_create(date("
						 Y-m-d H:i:s ")), 'd-m-Y H:i:s') ; ?>" size="27" />
	...
	<div class="modal-dialog modal-lg" role="document" style="width: 40%">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<span id="modalAction" class="fa fa-plus-square" style="color: #008000"> </span> Orden de Trabajo</h4>
			</div>
			<!-- /.modal-header  -->
			...
			<div class="modal-body input-group ui-widget" id="modalBodyArticle">
				...
				<div class="row">
					...
					<div class="col-xs-8">
						<input type="text" class="form-control" id="vfech" name="vfech" value="<?php echo date_format(date_create(date("
						 Y-m-d H:i:s ")), 'd-m-Y H:i:s') ; ?>" disabled/>
					</div>
				</div>
				<br>
	...
	<div class="modal-dialog modal-lg" role="document" style="width: 35%">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<span id="modalAction" class="fa fa-fw fa fa-toggle-on" style="color: #3c8dbc"> </span> Finalización </h4>
			</div>
			<!-- /.modal-header  -->
