<input type="" id="permission" style="width: 100%" value="<?php echo $permission;?>">
<div class="row">
  <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <?php
          ...
          // }
              ...
              // echo '<button class="btn btn-block btn-success" style="width: 100px; margin-top: 10px;" id="cargarEvetos">Refetch</button>';
                          ...
                          //var_dump($list);
                           if(count($list) > 0) {
                            ...
                            foreach($list as $a){
                              ...
                              echo '<td>';
                              echo '<i class="fa fa-cogs" style="color: #A9A9A9    "; cursor: "pointer" title="Fecha" data-toggle="modal" data-target="#modalAsignaEquipo"></i>';
                              echo '</td>';
...
//   ($a['estado'] == 'RE' ? '<small class="label label-default">Finalizada</small>' : '<small class="label label-default">Eliminada</small>')
// ).'</td>';
  ...
  ($a['estado'] == 'RE' ? '<small class="label label-default">Finalizada</small>' : 
    ($a['estado'] == 'AS' ? '<small class="label label-default">Asignada</small>' : '<small class="label label-default">Eliminada</small>'))).'</td>';
          ...
          <div class="modal-footer">              
            <button type="button" id="guardar" class="botones btn btn-primary" onclick="planificar()">Terminar Planificacion</button>
          </div>  <!-- /.modal footer -->            
            ...
            var evento = $.ajax({
                              ...
                              success: function(doc) {
                                  ...
                                  $(doc).each(function() {
                                      ...
                                      var duracion = parseInt($(this).attr('duracion_std'));
...
//////////////////////////////////////////////////////////////////////
  ...
  function getResources(handleData) {
    console.log('renderiz coalendar');
    alert(resources);
    $.ajax({
        type: 'POST',
        dataType: 'json',
        ...
        data: {
            //'data': resources
            'month': month_,
            'idSubsector': resources
        },
        success:function(data) {
          console.log('entrepor sucess');
          //$('#calendar').fullCalendar('refetchResources');
            handleData(data); 
        },
        error:function(){
...
//////////////// prueba claendario ////////////////////////
  ...
  // Al seleccionar sector llena selec de equipos del sector elegido
  $('#sectSelect').change(function(){
  ...
  // function rendEventosSector(idsubsector){  
...
////////////////////////////////////////////////////////////////
  ...
  //ASIGNAR FECHA 
    $(".fa-calendar").click(function (e) { 
      ...
      var duracion = $(this).parents("tr").find("td").eq(8).html();     
  ...
  $(document).ready(function(event) {
    ...
    $('#agregar').click(function (e) {      
      ...
      var tr = "<tr id='"+numord+"'>"+
                  ...
                  "<td></td>"+
                  "<td style='text-align: center' ><small class='label label-default' >Curso</td>"+
                  "<td><i class='fa fa-times-circle' style='color: #A9A9A9 '; cursor: 'pointer' title='Eliminar'></i> <i class=' fa fa-user' style='color: #A9A9A9 '; cursor: 'pointer' title='Asignacion de usuario' data-toggle='modal' data-target='#modalSale'></i> <i class='fa fa-cogs' style='color: #A9A9A9    '; cursor: 'pointer' title='Fecha' data-toggle='modal' data-target='#modalAsignaEquipo'></i></td>"+
                  /*"<td><i class=' fa fa-user' style='color: #A9A9A9 '; cursor: 'pointer' title='Asignacion de usuario' data-toggle='modal' data-target='#modalSale'></i></td>"+*/
                  // "<td  ><i class='fa fa-cogs' style='color: #A9A9A9    '; cursor: 'pointer' title='Fecha' data-toggle='modal' data-target='#modalAsignaEquipo'></i></td>"+
                "</tr>";          
      console.log(tr); 
    ...
    $("#fecha").datepicker({
     ...
     $("#cargarEvetos").click(function (e) {
        //alert('aprete boton');
       $('#calendar').fullCalendar( 'refetchEventSources', 'index.php/Otrabajo/getcalendarot' );
