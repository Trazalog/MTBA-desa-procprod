...
<section class="content">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      ...
      <style> input.prevent{border: none; padding-left: 5px; width: 100%;}.selmes{margin-bottom: 10px;}</style>
      ...
      <!-- <div role="tabpanel" class="tab-pane active" id="home">  -->       
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class=""><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Calendario</a></li>
