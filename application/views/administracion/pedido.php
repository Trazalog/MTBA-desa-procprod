                  ...
                  $usrId= $userdata[0]['usrId']; 
                     ...
                     if ($a['estado'] =='P'){
                      ...
                      if (strpos($permission,'Add') !== false) { //Entregar
                        ...
                        echo '<i class="fa fa-fw fa-pencil" style="color: #f39c12; cursor: pointer; margin-left: 15px;" title="Modificar proveedor" data-toggle="modal" data-target="#modaleditar" ></i>';
...
$(document).ready(function(event) {
  ...
  $('#listado').click( function cargarVista(){
    ...
    no=numord;
    console.log("El id de orden de trabajo es:");
    console.log(no);
    WaitingOpen();
    $('#content').empty(); 
...
*/
 ...
 $(".fa-pencil").click(function (e) { 
    ...
    var idop = $(this).parent('td').parent('tr').attr('id');
...
function guardarproveedor(){
  ...
  var idprov = $('#provee').val();
  //idoes el id de orden_pedido
  console.log("El id de orden de pedido es:");
  console.log(opgl);
  console.log("el id proveedor es: ");
  console.log(idprov);
 
  $.ajax({
        type: 'POST',
        data: {idprov:idprov, opgl:opgl},
        url: 'index.php/Administracion/ModificarProveedor',  //index.php/
        success: function(data){
                console.log("Estoy modificando la orden de  pedido");
                console.log(data);
                regresa();
...
<div class="modal fade" id="modaleditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document" style="width: 20%">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"  id="myModalLabel"><span id="modalAction" class="fa fa-fw fa-pencil" style="color: #f39c12" > </span> Reasignar Proveedor</h4>
      </div> <!-- /.modal-header  -->
      ...
      <div class="modal-body input-group ui-widget" id="modalBodyArticle">     
        <div class="row" >
          <div class="col-sm-12 col-md-12">
            ...
            <div class="col-xs-12">
             <select class="form-control" id="provee" name="provee" value="" ></select>
              <!--<input type="text"  class="form-control" id="num1" name="num1" placeholder="Ingrese nro de remito...">-->
              <!--align=\"right\" -->
            </div>
            <br>
          ...
          <br>
             ...
             <div class="col-xs-12" align="right">
                ...
                <button type="button" class="btn btn-primary " id="btnSave" data-dismiss="modal" onclick="guardarproveedor()" >SI</button>
