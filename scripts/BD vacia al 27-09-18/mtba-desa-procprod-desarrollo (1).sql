...
--
-- Servidor: localhost
-- Tiempo de generación: 27-09-2018 a las 17:11:50
...
(1, 'mauricio Perez', '2333698', 'dddd', 'permauricio@gmail.com', 'permauricio@gmail.com', '1'),
...
(3, '00000222', 'artículo Test 2', '0.00', '0.00', b'0', NULL, b'0', 'AC', 6),
(4, '00000333', 'artículo Test 3', '0.00', '0.00', b'0', NULL, b'0', 'AC', 5),
(5, '00000444', 'artículo Test 4', '0.00', '0.00', b'0', NULL, b'0', 'AC', 9),
(6, '00000555', 'artículo Test 5', '0.00', '0.00', b'0', NULL, b'0', 'AC', 10);
...
(7000, '', NULL, '2018-09-12 23:19:01', 7000, NULL);
...
(7000, 'Informe Tecnico', NULL, 1, '2018-09-12 23:06:23', NULL, NULL);
...
(7000, 'Informe Tecnico', NULL, '2018-09-12 23:24:56', 7000, 1);
...
(1027, 'Caño inferior retorno de tubo', NULL, NULL, NULL, 0, '2018-07-30 00:59:31', 7, 1000, 28),
...
(7000, 'Adjunto de Informe Técnico', NULL, NULL, NULL, 0, '2018-09-12 23:33:54', 7, 7000, 1);
...
(17, 'Ordenes_de_trabajo', '', 'fa fa-check-square-o', NULL, 21),
...
--
-- Estructura de tabla para la tabla `utl_feriados`
--

CREATE TABLE `utl_feriados` (
  `año` int(11) NOT NULL,
  `mes` int(11) NOT NULL,
  `dia` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `utl_feriados`
--

INSERT INTO `utl_feriados` (`año`, `mes`, `dia`, `motivo`, `tipo`) VALUES
(2018, 1, 1, 'Año Nuevo', 'inamovible'),
(2018, 2, 12, 'Carnaval', 'inamovible'),
(2018, 2, 13, 'Carnaval', 'inamovible'),
(2018, 3, 24, 'Día Nacional de la Memoria por la Verdad y la', 'inamovible'),
(2018, 3, 30, 'Viernes Santo Festividad Cristiana', 'inamovible'),
(2018, 4, 2, 'Día del Veterano y de los Caídos en la Guerra', 'inamovible'),
(2018, 5, 1, 'Día del Trabajador', 'inamovible'),
(2018, 5, 25, 'Día de la Revolución de Mayo', 'inamovible'),
(2018, 6, 17, 'Paso a la Inmortalidad del Gral. Don Martín G', 'nolaborable'),
(2018, 6, 20, 'Paso a la Inmortalidad del General Manuel Bel', 'inamovible'),
(2018, 7, 9, 'Día de la Independencia', 'inamovible'),
(2018, 8, 20, 'Paso a la Inmortalidad del General José de Sa', 'trasladable'),
(2018, 10, 15, 'Día del Respeto a la Diversidad Cultural', 'trasladable'),
(2018, 11, 19, 'Día de la Soberanía Nacional', 'trasladable'),
(2018, 12, 8, 'Inmaculada Concepción de María', 'inamovible'),
(2018, 12, 24, 'Feriado Puente Turístico', 'puente'),
(2018, 12, 25, 'Navidad', 'inamovible'),
(2018, 12, 31, 'Feriado Puente Turístico', 'puente');
...
--
-- Indices de la tabla `utl_feriados`
--
ALTER TABLE `utl_feriados`
  ADD PRIMARY KEY (`año`,`mes`,`dia`);
...
--
ALTER TABLE `sisgroupsactions`
  MODIFY `grpactId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `sismenuactions`
  MODIFY `menuAccId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
...
--
ALTER TABLE `tbl_listarea`
  MODIFY `id_listarea` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `trj_pedido_trabajo`
  MODIFY `petr_id` int(11) NOT NULL AUTO_INCREMENT;
