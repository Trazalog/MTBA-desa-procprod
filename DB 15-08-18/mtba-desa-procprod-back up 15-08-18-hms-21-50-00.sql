...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-08-2018 a las 21:46:53
...
(17, 'Ordenes de trabajo', '', 'fa fa-check-square-o', NULL, 6),
...
(25, 'Gestion Stock', '', 'fa fa-truck', NULL, 8),
...
(36, 'ABM', '', 'fa fa-tasks', NULL, 12),
(40, 'ABM Equipos', 'Equipo', 'fa fa-tasks', 36, 1),
(41, 'ABM Subsectores', 'Subsector', 'fa fa-tasks', 36, 2),
(42, 'ABM Tareas Estandar', 'Tareaest', 'fa fa-tasks', 36, 3),
(43, 'ABM Plantillas', 'Plantilla', 'fa fa-tasks', 36, 4);
...
(266, 17, 'tarea 1  plantilla  4', 18, 8, NULL, NULL, 0, NULL, NULL, 'AS', NULL),
(267, 17, 'tarea 2 pantilla 4', 19, NULL, NULL, NULL, 0, NULL, NULL, 'C', NULL),
(268, 17, 'tarea 3 plantilla 4', 20, NULL, NULL, NULL, 0, NULL, NULL, 'IN', NULL),
(269, 17, 'LIMPIE EL FILTRO DE ADMISIÓN DE AIRE. SE PUEDE LIMPIAR COMO MÁXIMO 6 VECES, LUEGO CAMBIAR.', 6, NULL, NULL, NULL, 0, NULL, NULL, 'IN', NULL),
(270, 17, 'CAMBIE EL FILTRO DE ADMISIÓN DE AIRE', 7, NULL, NULL, NULL, 0, NULL, NULL, 'IN', NULL);
...
--
ALTER TABLE `sisgroupsactions`
  MODIFY `grpactId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1969;
--
...
--
ALTER TABLE `tbl_listarea`
  MODIFY `id_listarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;
--
