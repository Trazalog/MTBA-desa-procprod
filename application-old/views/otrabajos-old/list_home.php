                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4 col-xs-12">
                          ...
                          <div class="small-box bg-blue">
                                ...
                                <span class="small-box-footer"> EL 96% de las órdenes se solucionaron antes de su vencimiento.</span>
                            </div>
                      </div>
                      ...
                      <div class="col-md-4 col-xs-12">
                          <div class="info-box bg-yellow">
                              ...
                              <div class="info-box-content">
                                  ...
                                  <span class="info-box-number">10/05/2017</span>
                                  <!-- The progress section is optional -->
                                  <div class="progress">
                                      <div class="progress-bar" style="width: 100%"></div>
                                  </div>
                                  <span class="progress-description">
                                      Hay 19 órdenes de servicio asignadas.
                                  </span>
                              </div><!-- /.info-box-content -->
                          </div><!-- /.info-box -->
...
<script>
  ...
  function graficarParametro() {
    ...
    var myChart = new Chart(areaChartCanvas, {
      type: 'doughnut',
      data: {
        labels: ["En curso", "Asignado", "Vencido"],
        datasets: [{
          data: [25, 19, 7],
          backgroundColor: [
          "#00a65a",
