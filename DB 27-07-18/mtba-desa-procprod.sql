...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-07-2018 a las 15:09:46
...
INSERT INTO `tareas` (`id_tarea`, `descripcion`, `duracion_std`) VALUES
(4, 'LIMPIE EL CUERPO DEL RADIADOR. UTILICE AIRE COMPRIMIDO.', 120),
(5, 'REVISE LA BOMBA DE AGUA', 60),
(6, 'LIMPIE EL FILTRO DE ADMISIÓN DE AIRE. SE PUEDE LIMPIAR COMO MÁXIMO 6 VECES, LUEGO CAMBIAR.', 60),
(7, 'CAMBIE EL FILTRO DE ADMISIÓN DE AIRE', 60),
(8, 'CAMBIE EL ACEITE DE MOTOR. ACEITE 15W40', 60),
(9, 'CAMBIE LOS FILTROS DE ACEITE.', 60),
(10, 'CAMBIE EL FILTRO DE COMBUSTIBLE DE MOTOR.', 60),
(12, 'LIMPIE EL DEPÓSITO DE COMBUSTIBLE.', 60),
(13, 'COMPRUEBE EL MOTOR DE ARRANQUE', 60),
(14, 'REVISE EL SENSOR DE TEMPERATURA.', 60),
(15, 'TOMAR MUESTRA DE ACEITE PARA ANÁLISIS DE LABORATORIO. USAR PROCEDIMIENTO PR0004EM', 60),
(16, 'REALIZAR ANÁLISIS DE TEMPERATURA. UTIIZAR CÁMARA TERMOMÉTRICA O PIRÓMETRO', 60),
(17, 'tarea de rectificacion subsector 2', 120);
...
(239, 17, 'LIMPIE EL CUERPO DEL RADIADOR. UTILICE AIRE COMPRIMIDO.', 4, 4, '2018-07-26 09:04:00', NULL, 2, NULL, NULL, 'AS', 0),
(240, 17, 'REVISE LA BOMBA DE AGUA', 5, 6, '2018-07-26 11:34:44', NULL, 4, NULL, NULL, 'AS', 265),
(241, 17, 'LIMPIE EL FILTRO DE ADMISIÓN DE AIRE. SE PUEDE LIMPIAR COMO MÁXIMO 6 VECES, LUEGO CAMBIAR.', 6, 9, '2018-07-10 15:49:24', NULL, 0, NULL, NULL, 'AS', 0),
(242, 17, 'CAMBIE EL FILTRO DE ADMISIÓN DE AIRE', 7, NULL, NULL, NULL, 0, NULL, NULL, 'IN', NULL),
(243, 17, 'REVISE EL SENSOR DE TEMPERATURA.', 14, NULL, NULL, NULL, 0, NULL, NULL, 'IN', 60),
(244, 17, 'LIMPIE EL FILTRO DE ADMISIÓN DE AIRE. SE PUEDE LIMPIAR COMO MÁXIMO 6 VECES, LUEGO CAMBIAR.', 6, 11, '2018-07-28 15:49:09', NULL, 0, NULL, NULL, 'AS', 0),
(245, 17, 'CAMBIE EL FILTRO DE ADMISIÓN DE AIRE', 7, NULL, NULL, NULL, 0, NULL, NULL, 'IN', NULL),
(246, 17, 'tarea de rectificacion subsector 2', 17, 5, '2018-07-21 09:58:25', NULL, 0, NULL, NULL, 'IN', 0),
(247, 17, 'REVISE EL SENSOR DE TEMPERATURA.', 14, NULL, NULL, NULL, 0, NULL, NULL, 'IN', 60),
(248, 17, 'LIMPIE EL FILTRO DE ADMISIÓN DE AIRE. SE PUEDE LIMPIAR COMO MÁXIMO 6 VECES, LUEGO CAMBIAR.', 6, NULL, '2018-07-27 10:58:44', NULL, 0, NULL, NULL, 'IN', 91),
(249, 17, 'CAMBIE EL FILTRO DE ADMISIÓN DE AIRE', 7, NULL, NULL, NULL, 0, NULL, NULL, 'IN', NULL),
(250, 17, 'LIMPIE EL FILTRO DE ADMISIÓN DE AIRE. SE PUEDE LIMPIAR COMO MÁXIMO 6 VECES, LUEGO CAMBIAR.', 6, NULL, NULL, NULL, 0, NULL, NULL, 'C', NULL),
(251, 17, 'CAMBIE EL FILTRO DE ADMISIÓN DE AIRE', 7, NULL, NULL, NULL, 0, NULL, NULL, 'C', NULL);
...
--
ALTER TABLE `frm_formularios_completados`
  MODIFY `FOCO_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=188;
--
...
--
ALTER TABLE `tbl_detanotapedido`
  MODIFY `id_detaNota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
--
...
--
ALTER TABLE `tbl_listarea`
  MODIFY `id_listarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=252;
--
-- AUTO_INCREMENT de la tabla `tbl_listplantilla`
--
ALTER TABLE `tbl_listplantilla`
  MODIFY `id_detaplantilla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tbl_notapedido`
  MODIFY `id_notaPedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
--
